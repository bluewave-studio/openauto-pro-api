...
class EventHandler(ClientEventHandler):
    ...
    def on_hello_response(self, client, message):
        ...
        register_audio_focus_receiver_request.category = oap_api.RegisterAudioFocusReceiverRequest.AUDIO_STREAM_CATEGORY_COMMUNICATION
    ...
    def toggle_transient(self, client):
        ...
        if self._transient:
            audio_focus_change_request.type = oap_api.AudioFocusChangeRequest.AUDIO_FOCUS_TYPE_TRANSIENT
        else:
